...
All four packages in this repo (`@tyler-rng/sprite-core`,
`@tyler-rng/sprite-core-client`, `ai.openclaw.spritecore:sprite-core-client`
...
- Plugin moved from repo root into `packages/plugin/`. Package name and
  ...
  `@tyler-rng/sprite-core` via the existing instructions.
